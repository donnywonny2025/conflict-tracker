...
const CONFIG = {
    ...
    presets: {
        iran: [
            ...
            { type: 'youtube', id: 'i_539x1jpXw', label: 'Times Now', region: 'INDIA' },
            { type: 'youtube', id: 'iipR5yUp36o', label: 'ABC News Live', region: 'USA' },
            { type: 'youtube', id: '8rD5quyoCo0', label: 'CBS News 24/7', region: 'USA' },
